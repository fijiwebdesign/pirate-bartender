...
/*$(document).ready(function() {
	...
	Pantry.prototype.getItem = function(pref, index) { //passing in an iterator (pref) that loops thru the user's array
		var item = this.pantry[pref]; //function?
...
/*function endQuestions() { 
	if (questionIndex == 5) {
			...
			for (var i = 0 ; i < preferences.ingredients.length; i++) {
				var pref = preferences.ingredients[i]; //[i] is each char in the array
...
//$('#question').append(bartenderQuestions.question[questionIndex]); //index is set to 0: question 0
